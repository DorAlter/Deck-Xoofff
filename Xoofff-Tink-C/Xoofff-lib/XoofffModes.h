...
/**
  * Deck-Tink Tag Length in bytes.
  */
#define Deck_Tink_TagLength      32
...
/**
  * Function to initialize a Deck_Tink instance with given key and nonce.
  * @param  xpInstance      Pointer to the instance to be initialized.
  * @param  Key             Pointer to the key (K).
  * @param  KeyBitLen       The length of the key in bits.
  * @return 0 if successful, 1 otherwise.
  */
int Deck_Tink_Initialize(Deck_Tink_Instance *xpInstance, const BitSequence *Key, BitLength KeyBitLen, const BitSequence *Nonce, BitLength NonceBitLen);
...
/**
  ...
  * @return 0 if successful, 1 otherwise.
  */
int Deck_Tink_Wrap(Deck_Tink_Instance *xpInstance, const BitSequence *plaintext, BitSequence *ciphertext, BitLength dataBitLen, 
...
/**
  ...
  * @return 0 if successful, 1 otherwise.
  */
int Deck_Tink_Unwrap(Deck_Tink_Instance *xpInstance, const BitSequence *ciphertext, BitSequence *plaintext, BitLength dataBitLen, 
