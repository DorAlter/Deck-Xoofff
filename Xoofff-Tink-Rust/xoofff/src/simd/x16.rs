...
impl Xoofff {
    ...
    pub fn absorb(&mut self, msg: &[u8], domain_seperator: u8, ds_bit_width: usize) {
        ...
        statex16_to_bytes(&states, &mut self.iblk);
...
#[inline(always)]
pub fn statex16_to_words(states: &[u32x16]) -> [[u32; LANE_CNT]; 16] {
...
#[inline(always)]
pub fn statex16_to_bytes(states: &[u32x16], out: &mut [u8; PAR_BLOCK_SIZE]) {
