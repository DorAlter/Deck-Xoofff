...
impl Xoofff {
    ...
    pub fn absorb(&mut self, msg: &[u8], domain_seperator: u8, ds_bit_width: usize) {
        ...
        statex8_to_bytes(&states, &mut self.iblk);
...
#[inline(always)]
pub fn statex8_to_words(states: &[u32x8]) -> [[u32; LANE_CNT]; 8] {
...
#[inline(always)]
pub fn statex8_to_bytes(states: &[u32x8], out: &mut [u8; PAR_BLOCK_SIZE]) {
