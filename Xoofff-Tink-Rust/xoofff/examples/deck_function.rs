...
fn main() {
    ...
    deck.absorb(&msg0, DOMAIN_SEPERATOR, DOMAIN_SEPERATOR_BIT_WIDTH);
    ...
    deck.absorb(&msg1, DOMAIN_SEPERATOR, DOMAIN_SEPERATOR_BIT_WIDTH);
    deck.squeeze(&mut dig);
    ...
    deck.absorb(&msg2, DOMAIN_SEPERATOR, DOMAIN_SEPERATOR_BIT_WIDTH);
    deck.squeeze(&mut dig);
    ...
    // absorb last message
    deck.absorb(&msg3, DOMAIN_SEPERATOR, DOMAIN_SEPERATOR_BIT_WIDTH);
    deck.squeeze(&mut dig);
